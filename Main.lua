...
Zunesh_Hub.MouseButton1Click:Connect(function()
	...
	if Zunesh_hub_click then
		-- Кнопки + ярлыки
		local ESP_Label = CreateLabel("ESP", UDim2.new(0,20,0,0), Frame)
		local ESP_Button = CreateButton("", UDim2.new(0,20,0,50), UDim2.new(0,40,0,40), Frame)
		...
		local AF_Label = CreateLabel("AutoFarm", UDim2.new(0,20,0,200), Frame)
		local AF_Button = CreateButton("", UDim2.new(0,20,0,250), UDim2.new(0,40,0,40), Frame)
