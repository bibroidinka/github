...
local AutoFarm_Click = false
local Zunesh_hub_click = false

_G.Enable_ESP = false
_G.Enable_ForPlayer = false
_G.Enable_AutoFarm = false
...
function ui.ToggleFrame()
	if Zunesh_hub_click == false then
		...
		AutoFarm.MouseButton1Click:Connect(function()
			if AutoFarm_Click == false then
				AutoFarm_Click = true
				_G.Enable_AutoFarm = true
			else
				AutoFarm_Click = false
				_G.Enable_AutoFarm = false
			end
		end)
